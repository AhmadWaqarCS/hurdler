...
export const STATIC_AGENTS: Record<string, AgentDefinition> = {
  ...
  'ui-designer': {
    ...
    systemPrompt:
      'Never create generic, plain, or barebones interfaces. Apply rich modern aesthetics, consistent design tokens, and smooth user interactions. Visually verify designs with Playwright screenshots.',
    allowedTools: [
      'file:read',
      'file:write',
      'file:edit',
    ...
    tags: ['ui', 'ux', 'design', 'frontend', 'components', 'playwright', 'visual'],
    isBuiltin: true,
    active: true,
  },
  ...
  'tester': {
    ...
    systemPrompt:
      'Write comprehensive, deterministic tests with clear assertion messages. Verify error branches, UI flows, and boundary limits thoroughly with Playwright automation.',
    allowedTools: [
      'file:read',
      'file:write',
      'file:edit',
    ...
    tags: ['testing', 'qa', 'automation', 'verification', 'playwright', 'e2e'],
    isBuiltin: true,
    active: true,
  },
